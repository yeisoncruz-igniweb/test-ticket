...
define('SECRET_SALT','EULS1SWjyrFzEwRj5QlyPHzLZFPOzydQ');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','test2@caymanwireless.com');
...
define('DBNAME','caymanwi_osticket');
define('DBUSER','caymanwi_support');
define('DBPASS','7VPst3G=Bse7');
